      ...
      >
        ...
        <div className="p-6 backdrop-blur-xl bg-white/20 shadow-lg rounded-2xl   max-w-5xl mx-auto space-y-4 ">
          <div className="flex flex-wrap flex-col  justify-between items-center space-y-4 md:space-y-0">
            <div>
              <Input
                className="bg-white rounded-full w-[270px] md:w-[600px] lg:w-[930px]  h-12 text-black"
                placeholder="Destination"
              />
            </div>
            <div className="flex flex-col md:flex-row gap-4 ">
              <div className="flex flex-row mt-4 gap-4">
                <DatePickerWithRange className="w-[270px] md:w-[300px] h-12 text-black" />
              </div>
              <div className="mt-4 items-center">
                <Input
                  className="bg-white rounded-full w-[270px] md:w-[300px] h-12 text-black  "
